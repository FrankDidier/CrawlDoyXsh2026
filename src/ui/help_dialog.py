...
class HelpDialog(QDialog):
    ...
    def _create_usage_tab(self) -> QWidget:
        ...
        <ol>
            ...
            <li><b>选择浏览器</b>: 网页版可选择Chrome/Edge/IE/360/QQ浏览器</li>
        ...
        <h3 style="color: #ffa502;">💡 浏览器选择建议</h3>
        <ul>
            <li><b>淘宝</b>: IE浏览器稳定性更高，较少出现验证</li>
            <li><b>京东</b>: Edge或Chrome都可以</li>
            <li><b>抖音/快手</b>: Chrome效果最好</li>
            <li>如果某个浏览器频繁出现验证，可切换到其他浏览器尝试</li>
        </ul>
...
playwright install chromium
    ...
    def _create_faq_tab(self) -> QWidget:
        ...
        <h3 style="color: #ff4757;">Q: 浏览器选择有什么作用?</h3>
        <p><b>A:</b> 不同浏览器有不同的指纹特征。如果一个浏览器频繁被要求验证，可以切换到其他浏览器尝试。
        <b>建议:</b> 淘宝用IE浏览器更稳定；京东建议用Edge；抖音/快手用Chrome。</p>
        
        <h3 style="color: #ff4757;">Q: 账号被封/提示"访问异常"怎么办?</h3>
        <p><b>A:</b> 平台会根据IP地址和浏览器指纹检测异常访问。建议:</p>
        <ul>
            <li>降低抓取数量，分批次抓取</li>
            <li>每次抓取间隔至少30分钟</li>
            <li>使用不同浏览器</li>
        ...
        <h3 style="color: #ff4757;">Q: 淘宝/京东显示"访问频繁"</h3>
        <p><b>A:</b> 电商平台反爬很严格。建议:</p>
        <ul>
            <li>每次只抓取一页(约50条)结果</li>
            <li>抓取完一个关键词后等待5-10分钟再抓下一个</li>
            <li>选择IE浏览器（淘宝对IE较友好）</li>
        </ul>
        
        <h3 style="color: #ff4757;">Q: 换关键词需要重新登录吗?</h3>
        <p><b>A:</b> 不需要！浏览器会保持打开状态，登录信息会保存。
        换关键词后直接点"开始抓取"即可在同一浏览器窗口继续。</p>
        """)
